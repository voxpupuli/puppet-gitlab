  ...
  on_supported_os(test_on).each do |os, facts|
    context "on #{os}" do
      ...
      describe 'Change Defaults' do
        ...
        context 'gitlab::cirunner::docker::tags: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
            default_tags => ['foo', 'bar']
          }"
        ...
        context 'gitlab::cirunner::docker::dns: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
            default_dns => ['foo', 'bar']
          }"
        ...
        context 'gitlab::cirunner::docker::dns_search: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
        ...
        context 'gitlab::cirunner::docker::volumes_from: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
        ...
        context 'gitlab::cirunner::docker::links: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
        ...
        context 'gitlab::cirunner::docker::services: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
        ...
        context 'gitlab::cirunner::docker::allowed_images: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
        ...
        context 'gitlab::cirunner::docker::allowed_services: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker':
