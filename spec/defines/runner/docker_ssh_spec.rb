  ...
  on_supported_os(test_on).each do |os, facts|
    context "on #{os}" do
      ...
      describe 'Change Defaults' do
        ...
        context 'gitlab::cirunner::docker_ssh::tags: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
            default_tags => ['foo', 'bar']
          }"
        ...
        context 'gitlab::cirunner::docker_ssh::dns: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
            default_dns => ['foo', 'bar']
          }"
        ...
        context 'dns: %w[foo bar]' do
          before { params.merge!(dns: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::dns_search: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'dns_search: %w[foo bar]' do
          before { params.merge!(dns_search: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::volumes_from: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'volumes_from: %w[foo bar]' do
          before { params.merge!(volumes_from: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::links: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'links: %w[foo bar]' do
          before { params.merge!(links: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::services: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'services: %w[foo bar]' do
          before { params.merge!(services: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::allowed_images: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'allowed_images: %w[foo bar]' do
          before { params.merge!(allowed_images: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
        ...
        context 'gitlab::cirunner::docker_ssh::allowed_services: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::docker_ssh':
        ...
        context 'allowed_services: %w[foo bar]' do
          before { params.merge!(allowed_services: %w[foo bar]) }
          it { is_expected.to compile }
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
