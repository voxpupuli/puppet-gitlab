...
describe 'gitlab::runner::virtualbox' do
  ...
  let(:pre_condition) { "class {'::gitlab::cirunner::virtualbox': }" }
  ...
  on_supported_os(test_on).each do |os, facts|
    context "on #{os}" do
      ...
      describe 'Change Defaults' do
        ...
        context 'gitlab::cirunner::virtualbox::run_untagged: true' do
          let(:pre_condition) do
        ...
        context 'gitlab::cirunner::virtualbox::run_untagged: false' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
            default_run_untagged => false
          }"
        ...
        context 'gitlab::cirunner::virtualbox::locked: true' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
            default_locked => true
          }"
        ...
        context 'gitlab::cirunner::virtualbox::locked: false' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
            default_locked => false
          }"
        ...
        context 'gitlab::cirunner::virtualbox::tags: %w[foo bar]' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
            default_tags => ['foo', 'bar']
          }"
        ...
        context "gitlab::cirunner::virtualbox::base_name: 'foobar'" do
          ...
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
            ).with_command(%r{--virtualbox-base-name foobar})
          end
        end
        ...
        context "gitlab::cirunner::virtualbox::template_name: 'foobar'" do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
          ...
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
            ).with_command(%r{--virtualbox-template-name foobar})
          end
        end
        ...
        context 'gitlab::cirunner::virtualbox::disable_snapshots: true' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
          ...
          it do
            is_expected.to contain_exec(
              "Register_runner_#{title}"
            ).with_command(%r{--virtualbox-disable-snapshots})
          end
        end
        ...
        context 'gitlab::cirunner::virtualbox::disable_snapshots: false' do
          let(:pre_condition) do
            "class {'::gitlab::cirunner::virtualbox':
